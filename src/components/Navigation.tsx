...
import { Home, Heart, Calendar, Users, FileText, ShoppingBag, Zap } from 'lucide-react';
        ...
        <div className="flex space-x-6">
          {navigationItems.map((item, index) => (
            <Link
              ...
              to={item.path}
              className={`
                flex flex-col items-center space-y-1 p-3 rounded-full transition-all duration-300
